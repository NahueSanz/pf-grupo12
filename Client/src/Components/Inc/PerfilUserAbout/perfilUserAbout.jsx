...
function PerfilUserAbout ({ user, profileIsCurrentUser }) {
    return(
        <Col>
                    ...
                    <Col>
                     {user.language && <p className='text-start'> <i className="bi bi-globe-americas"></i>  Speaks {user.language}.  </p>}
                     {user.country && <p className='text-start'> <i className="bi bi-geo-alt-fill"></i> Lives in {user.country}. </p>}
                     {user.phonenumber && <p className='text-start'> <i className="bi bi-telephone-fill"> </i>Contact {user.phonenumber}. </p>}
