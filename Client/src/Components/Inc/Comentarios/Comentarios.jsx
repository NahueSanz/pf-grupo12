...
import { changeEnabledReview } from '../../../redux/actions'
import { BsTrash } from 'react-icons/bs';
import { useDispatch } from "react-redux";
import style from './Comentarios.module.css';

function Comentarios({ id, user, review, score, idUserLogged }) {
  ...
  const handleOnClick = (id) => {
    dispatch(changeEnabledReview(id, false))
  }
      ...
      <Card.Body>
        ...
        <Card.Text className={style.containerText}>
          ...
          <div className={style.container2}>
            ...
            {idUserLogged === user.id && <button className={style.btnDelete} onClick={() => handleOnClick(id)}> <BsTrash size={15} /></button>}
          </div>
