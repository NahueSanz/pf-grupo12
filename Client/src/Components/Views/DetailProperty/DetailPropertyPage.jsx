...
import DateRangePickerComp from "../../Inc/CalendarComp/DaterangePickerComp";
    ...
    <Container className={`${style.container} container-fluid container pt-5`}>
      <Row>
        ...
        <Col className="mx-1 text-start col-12">
          <div className="d-flex align-items-center">
            <p>
              <span className="mr-2 fw-bolder">${property.price} USD</span>{" "}
              night │{" "}
            </p>
        ...
        <Col className="d-inline-flex text-start col-12 mt-3 mx-auto">
          <h6>
            ...
            <a href="#owner" className="link-danger link-offset-1">
              {owner}
            </a>
          </h6>
        </Col>
        <Col className="text-start mt-3 col-12">
          ...
          >
            ...
            >{`${property.address}, ${property.country}`}</a>
          </p>
        </Col>
        <Col className="p-3 mb-5 rounded" sm={12} md={12} lg={12}>
          <hr
            className="mb-4 border-top border-secondary"
            style={{ width: "100%" }}
          />
          <h3 className="fw-semibold mb-4">About this space</h3>
          <p className="lh-sm mt-4 paragraph mb-4">
            {property.description?.length > 475
              ? property.description.slice(0, 475).concat("...")
              : property.description}
          </p>
          {property.description?.length > 475 && (
            <ReadMore description={property.description} />
          )}
        </Col>
        <Col className="p-3 mb-5 rounded text-start col-12">
          ...
          <div className="d-flex align-items-center">
            <img
              ...
              alt="User picture"
              style={{ width: "60px", marginRight: "10px", height: "50px" }}
            />
            <div>
          ...
          <p className="d-inline-flex align-items-center mt-2">
            ...
            <span className="ms-1">
              ...
              <img
                ...
                alt="Star icon"
              />{" "}
              <span className="">Languages: {ownerLanguage} </span>{" "}
            </span>
          </p>
          <p className="lh-sm mt-4 paragraph mb-4">
            {ownerDescription?.length > 475
              ? ownerDescription.slice(0, 475).concat("...")
              : ownerDescription}
          </p>
          {ownerDescription?.length > 475 && (
            <ReadMore description={ownerDescription} />
          )}
        ...
        <Row
          className={`${style.reserveSm} reserve-sm  shadow bg-body rounded mx-auto border border-white`}
        >
      ...
      <Row className={`${style.owner} owner ms-2 shadow rounded w-50 pt-3`}>
        <Col className="text-center">
          ...
          <input
            type="date"
            className="rounded mb-4 mx-2 border border-secondary"
          ...
          <DateRangePickerComp />
          <Button
            className="btn-danger btn-sm my-2 mx-2"
            as={Link}
            to="/payment"
          >
            Reserve
